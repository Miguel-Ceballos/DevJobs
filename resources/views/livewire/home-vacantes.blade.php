<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto md:p-12">
                ...
                @forelse($vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            ...
                            <p class="font-bold text-xs text-gray-600">Ultimo dia para postularse: <span
                                    class="font-normal">{{ $vacante->ultimo_dia->format('d/m/Y') }}</span></p>
                        </div>
                        <div class="mt-5 md:mt-0">
                            <a href="{{ route('vacantes.show', $vacante->id) }}"
                               class="bg-indigo-500 p-3 rounded-lg text-sm font-bold uppercase text-white block text-center">
                                Ver vacantes
                            </a>
                        </div>
                    </div>
